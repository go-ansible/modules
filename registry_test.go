...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"apache2_module", "apk", "apt", "apt_key", "apt_repository", "archive",
		"assemble", "assert", "async_status", "at", "authorized_key", "awall",
		"beadm", "blockinfile", "bootc_manage", "btrfs_info", "btrfs_subvolume",
		"bundler", "bzr", "capabilities", "cargo", "cloud_init_data_facts",
		...
		"debconf", "debug", "decompress", "deploy_helper", "django_command",
		...
		"icinga2_downtime", "icinga2_feature", "icinga2_host",
		...
		"iptables_state", "iso_create", "iso_customize", "iso_extract",
		"java_cert", "java_keystore", "jboss", "kdeconfig", "kernel_blacklist",
		"kibana_plugin", "known_hosts", "kopia_repository",
		"kopia_repository_info", "krb_ticket", "launchd", "layman", "lbu",
		"ldap_attrs", "ldap_entry", "ldap_inc", "ldap_passwd", "ldap_search",
		"lineinfile", "listen_ports_facts", "lldp_facts", "locale_gen",
		"logrotate", "logstash_plugin", "lvg", "lvg_rename", "lvm_pv",
		"lvm_pv_move_data", "lvol", "lxc_container", "lxd_container",
		...
		"nmcli", "nomad_job", "nomad_job_info", "nomad_token", "npm",
		"nsupdate", "ohai", "omapi_host", "open_iscsi", "openbsd_pkg",
		"opendj_backendprop", "openwrt_init", "opkg", "osx_defaults",
		"pacemaker_cluster", "pacemaker_info", "pacemaker_resource", "package",
		"package_facts", "pacman", "pacman_key", "pam_limits", "pamd", "parted",
		"patch", "pause", "pear", "pids", "ping", "pip", "pip_package_info",
		"pipx", "pipx_info", "pkg5", "pkg5_publisher", "pkgin", "pkgng",
		"pkgutil", "pmem", "pnpm", "portage", "portinstall", "puppet",
		"python_requirements_info", "raw", "read_csv", "reboot",
		"redhat_subscription", "redis", "redis_data", "redis_data_incr",
		"redis_data_info", "redis_info", "replace", "rhel_facts",
		"rhel_rpm_ostree", "rhsm_release", "rhsm_repository", "rpm_key",
		"rpm_ostree_pkg", "rpm_ostree_upgrade", "runit", "script", "seboolean",
		"sefcontext", "selinux", "selinux_permissive", "selogin", "seport",
		"service", "service_facts", "set_fact", "set_stats", "setup", "shell",
		"shutdown", "slackpkg", "slurp", "snap", "snap_alias", "snmp_facts",
		"ssh_config", "sssd_info", "stat", "subversion", "sudoers",
		"supervisorctl", "svr4pkg", "synchronize", "sysctl", "syspatch",
		"sysrc", "systemd", "systemd_creds_decrypt", "systemd_creds_encrypt",
		"systemd_info", "systemd_service", "sysvinit", "tempfile", "template",
		"terraform", "timezone", "ufw", "unarchive", "uri", "usb_facts", "user",
