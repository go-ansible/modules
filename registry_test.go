...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"hwc_vpc_route", "hwc_vpc_security_group",
		"hwc_vpc_security_group_rule", "hwc_vpc_subnet", "icinga2_downtime",
		"icinga2_feature", "icinga2_host", "imgadm", "influxdb_database",
		...
		"ipa_sudorule", "ipa_user", "ipa_vault", "ipmi_boot", "ipmi_power",
		"iptables", "iptables_state", "iso_create", "iso_customize",
		...
		"kdeconfig", "kernel_blacklist", "keycloak_authentication",
		...
		"nosh", "npm", "nsupdate", "odbc", "ohai", "omapi_host", "open_iscsi",
		"openbsd_pkg", "opendj_backendprop", "openwrt_init", "opkg",
		"osx_defaults", "pacemaker_cluster", "pacemaker_info",
		"pacemaker_resource", "package", "package_facts", "packet_device",
		"packet_ip_subnet", "packet_project", "packet_sshkey", "packet_volume",
		"packet_volume_attachment", "pacman", "pacman_key", "pam_limits",
		"pamd", "parted", "patch", "pause", "pear", "pids", "ping", "pip",
		"pip_package_info", "pipx", "pipx_info", "pkg5", "pkg5_publisher",
		"pkgin", "pkgng", "pkgutil", "pmem", "pnpm", "portage", "portinstall",
		"puppet", "python_requirements_info", "raw", "read_csv", "reboot",
		"redhat_subscription", "redis", "redis_data", "redis_data_incr",
		"redis_data_info", "redis_info", "replace", "rhel_facts",
		"rhel_rpm_ostree", "rhsm_release", "rhsm_repository", "riak", "rpm_key",
		"rpm_ostree_pkg", "rpm_ostree_upgrade", "runit", "say",
		"scaleway_compute", "scaleway_compute_private_network",
		...
		"scaleway_function_namespace_info", "scaleway_image_info",
		"scaleway_ip", "scaleway_ip_info", "scaleway_lb",
		...
		"setup", "shell", "shutdown", "simpleinit_msb", "slackpkg", "slurp",
		...
		"vmadm", "wait_for", "wait_for_connection", "wakeonlan",
		"write_binary_file", "xattr", "xbps", "xdg_mime", "xenserver_facts",
		"xenserver_guest", "xenserver_guest_info", "xenserver_guest_powerstate",
		"xfconf", "xfconf_info", "xfs_quota", "xml", "xml_info", "yarn",
		"yum_repository", "yum_versionlock", "zfs", "zfs_delegate_admin",
		"zfs_facts", "znode", "zpool", "zpool_facts", "zypper",
		"zypper_repository", "zypper_repository_info",
	}
	names := r.Names()
