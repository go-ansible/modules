...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"hostname", "htpasswd", "icinga2_downtime", "icinga2_feature",
		"icinga2_host", "imgadm", "influxdb_database", "influxdb_query",
		...
		"iso_create", "iso_customize", "iso_extract", "java_cert",
		"java_keystore", "jboss", "kdeconfig", "kernel_blacklist", "keyring",
		...
		"riak", "rpm_key", "rpm_ostree_pkg", "rpm_ostree_upgrade", "runit",
		"say", "script", "seboolean", "sefcontext", "selinux",
		"selinux_permissive", "selogin", "seport", "serverless", "service",
		"service_facts", "set_fact", "set_stats", "setup", "shell", "shutdown",
		"simpleinit_msb", "slackpkg", "slurp", "smartos_image_info", "snap",
		"snap_alias", "snap_connect", "snmp_facts", "solaris_zone", "sorcery",
		"ssh_config", "sssd_info", "stat", "statsd", "subversion", "sudoers",
		...
		"terraform", "timezone", "udm_dns_record", "udm_dns_zone", "udm_group",
		"udm_share", "udm_user", "ufw", "unarchive", "uri", "urpmi",
		...
		"wait_for_connection", "wakeonlan", "write_binary_file", "xattr",
		"xbps", "xdg_mime", "xenserver_facts", "xenserver_guest",
