...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"capabilities", "cargo", "command", "composer", "consul_kv",
		"consul_kv_info", "copy", "cpanm", "cron", "cronvar", "crypttab",
		"dconf", "deb822_repository", "debconf", "debug", "decompress",
		"deploy_helper", "django_command", "django_manage", "dnf", "dnf5",
		"dnf_config_manager", "dnf_versionlock", "dpkg_selections", "expect",
		"fail", "fetch", "file", "filesize", "filesystem", "find", "firewalld",
		"firewalld_info", "flatpak", "flatpak_remote", "gather_facts", "gem",
		"get_url", "getent", "gio_mime", "git", "git_config", "git_config_info",
		"golang_package", "group", "haproxy", "homebrew", "homebrew_cask",
		"homebrew_services", "homebrew_tap", "homectl", "hostname", "htpasswd",
		"ini_file", "installp", "interfaces_file", "ipa_dnsrecord",
		"ipa_dnszone", "ipa_group", "ipa_hbacrule", "ipa_host", "ipa_hostgroup",
		"ipa_role", "ipa_service", "ipa_sudorule", "ipa_user", "iptables",
		...
		"lvg_rename", "lvm_pv", "lvm_pv_move_data", "lvol", "macports", "mail",
		"maven_artifact", "modprobe", "monit", "mount", "mount_facts", "nagios",
		"nmcli", "npm", "nsupdate", "open_iscsi", "openbsd_pkg", "opkg",
		...
		"reboot", "redis", "redis_data", "redis_data_incr", "redis_data_info",
		"redis_info", "replace", "rhel_facts", "rhel_rpm_ostree", "rpm_key",
		"rpm_ostree_upgrade", "runit", "script", "seboolean", "sefcontext",
		"selinux", "selinux_permissive", "selogin", "seport", "service",
		"service_facts", "set_fact", "set_stats", "setup", "shell", "slackpkg",
		"slurp", "snap", "snap_alias", "snmp_facts", "ssh_config", "stat",
		"subversion", "sudoers", "supervisorctl", "svr4pkg", "synchronize",
		"sysctl", "syspatch", "sysrc", "systemd", "systemd_info",
		"systemd_service", "sysvinit", "tempfile", "template", "terraform",
		"timezone", "ufw", "unarchive", "uri", "usb_facts", "user",
		"validate_argument_spec", "vdo", "wait_for", "wait_for_connection",
		"wakeonlan", "xattr", "xbps", "xdg_mime", "xfs_quota", "xml",
		"xml_info", "yarn", "yum_repository", "yum_versionlock", "zfs",
		"zfs_delegate_admin", "zfs_facts", "zpool", "zpool_facts", "zypper",
