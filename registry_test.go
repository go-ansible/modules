...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"ali_instance_info", "alternatives", "android_sdk",
		"ansible_galaxy_install", "apache2_mod_proxy", "apache2_module", "apk",
		"apt", "apt_key", "apt_repo", "apt_repository", "apt_rpm", "archive",
		"assemble", "assert", "async_status", "at", "authorized_key", "awall",
		"beadm", "blockinfile", "bootc_manage", "bower", "btrfs_info",
		"btrfs_subvolume", "bundler", "bzr", "capabilities", "cargo",
		"cloud_init_data_facts", "cloudflare_dns", "cobbler_sync",
		"cobbler_system", "command", "composer", "consul",
		...
		"homectl", "honeybadger_deployment", "hostname", "hponcfg", "htpasswd",
		...
		"ipa_vault", "ipinfoio_facts", "ipmi_boot", "ipmi_power", "iptables",
		...
		"jira", "kdeconfig", "kernel_blacklist", "keycloak_authentication",
		"keycloak_authentication_required_actions", "keycloak_authentication_v2",
		"keycloak_authz_authorization_scope", "keycloak_authz_custom_policy",
		"keycloak_authz_permission", "keycloak_authz_permission_info",
		"keycloak_client", "keycloak_client_rolemapping",
		"keycloak_client_rolescope", "keycloak_clientscope",
		"keycloak_clientscope_rolemappings", "keycloak_clientscope_type",
		"keycloak_clientsecret_info", "keycloak_clientsecret_regenerate",
		"keycloak_clienttemplate", "keycloak_component",
		"keycloak_component_info", "keycloak_group",
		...
		"selogin", "seport", "serverless", "service", "service_facts",
		"set_fact", "set_stats", "setup", "shell", "shutdown", "simpleinit_msb",
		"sl_vm", "slackpkg", "slurp", "smartos_image_info", "snap", "snap_alias",
		"snap_connect", "snmp_facts", "solaris_zone", "sorcery", "ss_3par_cpg",
