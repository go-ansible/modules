...
func TestRegistryDefault(t *testing.T) {
	...
	want := []string{
		...
		"capabilities", "cargo", "cloud_init_data_facts", "cloudflare_dns",
		"cobbler_sync", "cobbler_system", "command", "composer", "consul",
		"consul_acl_bootstrap", "consul_agent_check", "consul_agent_service",
		"consul_auth_method", "consul_binding_rule", "consul_kv",
		"consul_kv_info", "consul_policy", "consul_role", "consul_session",
		"consul_token", "copr", "copy", "cpanm", "cron", "cronvar", "crypttab",
		"dconf", "deb822_repository", "debconf", "debug", "decompress",
		"deploy_helper", "django_check", "django_command",
		...
		"homectl", "hostname", "hponcfg", "htpasswd", "hwc_ecs_instance",
		"hwc_evs_disk", "hwc_network_vpc", "hwc_smn_topic", "hwc_vpc_eip",
		"hwc_vpc_peering_connect", "hwc_vpc_port", "hwc_vpc_private_ip",
		"hwc_vpc_route", "hwc_vpc_security_group", "hwc_vpc_security_group_rule",
		"hwc_vpc_subnet", "ibm_sa_domain", "ibm_sa_host", "ibm_sa_host_ports",
		"ibm_sa_pool", "ibm_sa_vol", "ibm_sa_vol_map", "icinga2_downtime",
		"icinga2_feature", "icinga2_host", "idrac_redfish_command",
		"idrac_redfish_config", "idrac_redfish_info", "ilo_redfish_command",
		"ilo_redfish_config", "ilo_redfish_info", "imgadm", "influxdb_database",
		"influxdb_query", "influxdb_retention_policy", "influxdb_user",
		"influxdb_write", "ini_file", "installp", "interfaces_file", "ip_netns",
		"ipa_config", "ipa_dnsrecord", "ipa_dnszone", "ipa_getkeytab",
		"ipa_group", "ipa_hbacrule", "ipa_host", "ipa_hostgroup",
		"ipa_otpconfig", "ipa_otptoken", "ipa_pwpolicy", "ipa_role",
		"ipa_service", "ipa_subca", "ipa_sudocmd", "ipa_sudocmdgroup",
		"ipa_sudorule", "ipa_user", "ipa_vault", "ipinfoio_facts", "ipmi_boot",
		"ipmi_power", "iptables", "iptables_state", "ipwcli_dns", "iso_create",
		"iso_customize", "iso_extract", "java_cert", "java_keystore", "jboss",
		"jenkins_build", "jenkins_build_info", "jenkins_credential",
		"jenkins_job", "jenkins_job_info", "jenkins_node", "jenkins_plugin",
		"jenkins_script", "kdeconfig", "kernel_blacklist",
		...
		"mattermost", "maven_artifact", "mksysb", "modprobe", "monit", "mount",
		"mount_facts", "mqtt", "mssql_db", "mssql_script", "nagios",
		"newrelic_deployment", "nginx_status_info", "nictagadm", "nmcli",
		"nomad_job", "nomad_job_info", "nomad_token", "nosh", "npm", "nsupdate",
		"odbc", "ohai", "omapi_host", "one_host", "one_image", "one_image_info",
		"one_service", "one_template", "one_vm", "one_vnet", "onepassword_info",
		"open_iscsi", "openbsd_pkg", "opendj_backendprop", "openwrt_init",
		"opkg", "osx_defaults", "ovh_ip_failover",
		...
		"snmp_facts", "solaris_zone", "sorcery", "ss_3par_cpg", "ssh_config",
		"sssd_info", "stacki_host", "stat", "statsd", "subversion", "sudoers",
